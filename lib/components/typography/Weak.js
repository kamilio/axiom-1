...
var Weak = function (_Component) {
  _inherits(Weak, _Component);

  function Weak() {
    _classCallCheck(this, Weak);

    return _possibleConstructorReturn(this, (Weak.__proto__ || Object.getPrototypeOf(Weak)).apply(this, arguments));
  }
  ...
  _createClass(Weak, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _bwAxiom.Base,
        _extends({}, rest, { Component: 'span', className: 'ax-text--weak' }),
        children
      );
    }
  }]);
