  ...
  _createClass(Link, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          inheritColor = _props.inheritColor,
          rest = _objectWithoutProperties(_props, ['children', 'inheritColor']);

      var classes = (0, _classnames2.default)('ax-link', {
        'ax-link--inherit-color': inheritColor
      });

      return _react2.default.createElement(
        _bwAxiom.Base,
        _extends({}, rest, { Component: 'a', className: classes }),
        children
      );
    }
  }]);
...
Link.propTypes = {
  ...
  inheritColor: _react.PropTypes.bool
};
