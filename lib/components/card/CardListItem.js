  ...
  _createClass(CardListItem, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['active', 'children', 'onClick']);

      var classes = (0, _classnames2.default)('ax-card-list__item', {
      ...
      return _react2.default.createElement(
        _bwAxiom.Base,
        _extends({}, rest, { Component: 'li', className: classes, onClick: onClick }),
        children
      );
    }
  }]);
