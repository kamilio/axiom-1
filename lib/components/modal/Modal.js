  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['overlayClassName', 'withOverlay']);

      return _react2.default.createElement(_reactModal2.default, _extends({}, rest, {
        className: 'ax-modal',
        closeTimeoutMS: parseInt((0, _bwAxiom.getCSSVar)('modal-animation-duration'), 10),
